...
const HewittBuildersLogo: React.FC<LogoProps> = ({
	...
	return (
		...
		>
			...
			{/* Main "HEWITT" text */}
			<path fill={fill} d="M0,0h3.15v14.53h19.05V0h3.15v33.63h-3.15v-16.46H3.15v16.46H0V0Z" />
			<path fill={fill} d="M31.37,0h22.86v2.78h-19.71v12.09h18.06v2.73h-18.06v13.12h20.23v2.92h-23.38V0Z" />
			<path
				fill={fill}
			...
			/>
			<path fill={fill} d="M101.04,0h3.15v33.63h-3.15V0Z" />
			<path fill={fill} d="M119.67,2.82h-11.38V0h25.87v2.82h-11.34v30.81h-3.15V2.82Z" />
			<path fill={fill} d="M148.03,2.82h-11.38V0h25.87v2.82h-11.34v30.81h-3.15V2.82Z" />

			{/* Dividing line */}
			<line y1="41.1" x2="162.95" y2="41.1" fill="none" stroke={stroke} strokeMiterlimit="10" strokeWidth="0.75" />
			...
			/>
			<path fill={fill} d="M34.25,68.19h-.84v-19.34h.84v19.34Z" />
			<path fill={fill} d="M38.68,67.41h11.12v.78h-11.95v-19.34h.84v18.55Z" />
			<path
				fill={fill}
			...
			/>
			<path fill={fill} d="M70.68,57.81h10.93v.76h-10.93v8.84h12.14v.78h-12.98v-19.34h12.71v.76h-11.87v8.19Z" />
			<path
				fill={fill}
