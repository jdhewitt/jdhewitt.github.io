...
const HewittBuildersLogo: React.FC<LogoProps> = ({
	...
	return (
		...
		>
			...
			/>
			<path className="fill-neutral-900 dark:fill-white" d="M34.25,68.19h-.84v-19.34h.84v19.34Z" />
			<path className="fill-neutral-900 dark:fill-white" d="M38.68,67.41h11.12v.78h-11.95v-19.34h.84v18.55Z" />
			<path
				className="fill-neutral-900 dark:fill-white"
